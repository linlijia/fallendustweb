 ...
 */
@Data
@TableName("t_device_status_ex")
public class DeviceStatusEx implements Serializable {
    ...
    public DeviceStatusExHistory convert2DeviceStatusExHistory() {
        String json = JSON.toJSONString(this);
        DeviceStatusExHistory deviceStatusExHistory = JSON.parseObject(json, DeviceStatusExHistory.class);
        deviceStatusExHistory.setId(null);
        return deviceStatusExHistory;
    }
