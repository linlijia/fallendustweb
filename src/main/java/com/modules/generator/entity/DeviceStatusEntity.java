...
@TableName("dust_device_status")
public class DeviceStatusEntity implements Serializable {
    private static final long serialVersionUID = 1L;

    public DeviceStatusHistoryEntity convert2DeviceStatusHistory() {
        String json = JSON.toJSONString(this);
        DeviceStatusHistoryEntity deviceStatusHistoryEntity = JSON.parseObject(json, DeviceStatusHistoryEntity.class);
        deviceStatusHistoryEntity.setId(null);
        return deviceStatusHistoryEntity;
    }
